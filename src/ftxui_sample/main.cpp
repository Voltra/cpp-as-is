...
// configuration step. It creates a namespace called `cpp_as_is`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_as_is::cmake::project_name, cpp_as_is::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cpp_as_is::cmake::project_version);
      return EXIT_SUCCESS;
    }
